...
def verify_email(request, uidb64, token):
    ...
    if user is not None and default_token_generator.check_token(user, token):
        ...
        subject = 'Your Login Credentials for Emergency Trigger System'
        message = render_to_string('customadmin/credentials_email.html', {
            'username': user.username,
            'password': 'Emergency@1',
...
class CreateUserView(View):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            user.set_password('Emergency@1')  # Set the default password
            user.save()
            ...
            # Prepare the email
            subject = 'Verify Your Account for Emergency Trigger System'
