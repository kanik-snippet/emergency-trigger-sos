...
class SubscribeView(APIView):
    ...
    def post(self, request):
        ...
        subject = "Emergency Trigger: Welcome to Our Newsletter!"
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if serializer.is_valid():
                ...
                try:
                    email = EmailMultiAlternatives(
                        subject="Welcome to Emergency Trigger System – Verify Your Account",
                        body=message,
                ...
                return Response({
                    'status': 'success',
                    'message': _("Registration successfull Please check your email to verify your account. Thank you for joining the Emergency Trigger System.")
...
class PasswordResetRequestAPIView(APIView):
    ...
    def post(self, request):
        ...
        subject = 'Emergency Trigger System - Reset Your Password'
...
class PasswordResetAPIView(APIView):
    ...
    def post(self, request, token):
        try:
            ...
            password_reset(user)
            # Send the email
            subject = "Emergency Trigger System - Password Reset Confirmation"
            from_email = settings.DEFAULT_FROM_EMAIL
            to_email = user.email
...
def send_sos_verification_email(request,verification_url, sos_email):
    ...
    subject = f'Emergency Trigger System {request.user.username} Has Added You as an SOS Contact in the Emergency Trigger System'
...
def send_verification_sms(phone_number, verification_url, user_name,sos_name):
    try:
        ...
        message_body = (
            f"Hi {sos_name},\n\n"
            f"{user_name} added you as an SOS contact in the Emergency Trigger System. "
    ...
    def get(self, request,uidb64, token):
        try:
            ...
            try:
                ...
                message_body = (
                    f"Hi {sos_phone.name},\n\n"
                    f"{sos_phone.user.username} added you as an emergency contact in the Emergency Trigger System. "
...
class DeleteSOSContactView(APIView):
    ...
    def send_email_notification(self, email, user_name):
        ...
        try:
            ...
            message = (
                f"Hi,\n\n"
                f"This is to notify you that you have been removed as an SOS contact for {user_name} in the Emergency Trigger System.\n\n"
...
#         email_message = (
#             f"Dear User,\n\n"
#             f"The email, {user_email}, has been successfully removed from the Emergency Trigger System for user {user_name}. "
#             f"If this was done in error or you need assistance, please contact our support team.\n\n"
#             f"Best regards,\nThe Emergency Trigger Team"
#         )

#         send_mail(
#             subject='Email Removed from Emergency Trigger System',
...
#         client = Client(settings.TWILIO_ACCOUNT_SID, settings.TWILIO_AUTH_TOKEN)
#         sms_message = (
#             f"The phone number {user_phone} has been successfully removed from the Emergency Trigger System. If this was not authorized, please contact support immediately.\n"
#             f"Best regards,\Codrenic"
#         )
    ...
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            try:
                ...
                subject_user = "Emergency Trigger Confirmation of Your Order Form Submission"
...
class CheckStreamAPIView(APIView):
        ...
        try:
            ...
            if not devices.exists():
                return Response({
                    "live": False,
                    "allowed": False,
                    "reason": "No active device assigned."
                })
            ...
            any_live = any(item["live"] for item in results)
    ...
    def is_stream_live_hls(self, url):
        try:
...
class SendAlertView(APIView):
    ...
    @swagger_auto_schema(
        operation_description="Send a predefined alert ('1') to one or more devices. Provide device_ids list or 'all' to send to all devices of the user.",
        request_body=openapi.Schema(
            type=openapi.TYPE_OBJECT,
            properties={
                'device_ids': openapi.Schema(
                    ...
                    description="List of device IDs to send alert to, or use 'all' to send to all devices"
                )
            },
            required=['device_ids']
        ),
        responses={
            200: openapi.Response(
                description="Alert(s) sent successfully",
                schema=openapi.Schema(
                    type=openapi.TYPE_OBJECT,
                    properties={
                        ...
                        'results': openapi.Schema(
                            type=openapi.TYPE_ARRAY,
                            items=openapi.Schema(type=openapi.TYPE_STRING, example="Alert sent to Device 1")
                        )
                    }
                )
            ),
